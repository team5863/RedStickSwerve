  ...
  public final class Constants {
    ...
    public static class CommandConstants {
      ...
      public static class FeedWheel {
        ...
        public static class Climber {
          public static final int NEOclimberID = 18;
          public static final int CIMclimberID = 19;
      }
    }
    ...
    public static class BackRightModule { //FrontLeftModule {
    ...
    public static class BackLeftModule { //FrontRightModule {
    ...
    public static class FrontRightModule { //BackLeftModule {
    ...
    public static class FrontLeftModule {//BackRightModule {
